...
/** Arrow alone takes `style`, so callers can rotate it into a back-arrow. */
type ArrowProps = IconProps & { style?: CSSProperties };
...
const Arrow = ({ size = 18, style }: ArrowProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" focusable="false" style={style} {...stroke} strokeWidth="2">
    <path d="M5 12h14" />
