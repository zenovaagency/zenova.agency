...
export function ProjectDetailPage() {
  ...
  // The floating "Live site" button is portalled into document.body, which does
  // not exist while this renders on the server. useIsMounted() is false through
  // hydration and true after, so the server and the client's first render agree
  // and the button appears on the next commit.
  //
  // The button is redundant for crawlers either way: the same URL is already a
  // plain <a> in the banner and in the facts rail.
